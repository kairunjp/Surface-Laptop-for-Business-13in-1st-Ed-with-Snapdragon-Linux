...
The base DTS also enables the internal Qualcomm UFS PHY and host controller.
...
The UFS nodes are part of the base tree rather than a separate overlay. This
matches the hardware-tested `proxmox` boot path: the nodes were already
described in the board DT, but had been left disabled. All generated variants
therefore retain the same internal-storage description.
